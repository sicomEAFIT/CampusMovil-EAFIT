...
public class UserMarkersManager extends ListActivity implements SubscribedActivities {
	...
	public void retrieveUserMarkerNotes(){
		...
		if(httpHandler.isInternetConnectionAvailable(this)){
			httpHandler.sendRequest(HttpHandler.API_V1, ACTION_MARKER_NOTES, 
					"?auth=" + UserData.getToken() + "&lat=" + latitude + 
					"&long=" + longitude + "&title=" + title, paramsForHttpPost, 
					new HttpGet(), UserMarkersManager.this); 
		}else{
	...
	//TODO
	public void goToSelectedNote(String windowTitle, String windowSubtitle){
		Intent openBuildingInfo = new Intent(UserMarkersManager.this, InformationManager.class); 					
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(windowTitle != getResources().getString(R.string.no_results_found)){
			goToSelectedNote(windowTitle, windowSubtitle);  
		}
	}
